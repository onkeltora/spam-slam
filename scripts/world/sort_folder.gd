...
extends SortTarget
## A desktop folder icon = one sorting target (90er era). Slot position/preview/hit/
## miss animation state live in the base class SortTarget; this only draws the icon.
